...
from helpers.AnovosFunctionOperator import evaluate_functions
from reports.ReportBuilder import get_report
from reports.ReportViz import generate_visualisations
from anovos.shared.spark import spark
from anovos.shared.utils import ends_with


def main(all_configs, all_anovos_configs, run_type):
    ...
    node_count = all_configs.get("node_counts")
    ...
    report_df = get_report(spark, execution_time_list, dataset_name, column_ratio, machine_type, node_count, functions)
...
def evaluate(eval_config_path, anovos_config_path, run_type):
    ...
    main(all_configs, all_anovos_configs, run_type)
