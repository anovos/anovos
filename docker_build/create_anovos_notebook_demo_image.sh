...
sudo docker build -f Dockerfile_notebook_demo . -t anovos-nb-demo

# Spin up a container and start notebook
sudo docker run --name anovos_nb_demo -p 8888:8888 anovos-nb-demo:latest
